namespace Vidley.Migrations
{
    ...
    public partial class fixCustomersTypo : DbMigration
    {
        public override void Up()
        {
            ...
            DropColumn("dbo.Customers", "MemnbershipTypeId");
        }
        
        public override void Down()
        {
            AddColumn("dbo.Customers", "MemnbershipTypeId", c => c.Byte(nullable: false));
